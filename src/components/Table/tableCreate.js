...
let TableCreate = ({
	...
	<div>
		<Title title='Nueva venta (Mesas)' />
		<Paper className={classes.createContainer}>
			<h6 className={classes.formTitle}>Nueva venta (Mesas)</h6>
			<form>
...
TableCreate = reduxForm({
	form: 'TableCreate',
})(TableCreate);

const selector = formValueSelector('TableCreate');
...
const mapDispatchToProps = dispatch => ({
	actionSelectEvent: (event, id) => dispatch(setAccessEvent3(event, id)),
