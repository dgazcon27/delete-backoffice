...
let TicketCreate = ({
	...
	<div>
		<Title title='Nueva venta (Taquilla)' />
		<Paper className={classes.createContainer}>
			<h6 className={classes.formTitle}>Nueva venta (Taquilla)</h6>
			<form>
...
TicketCreate = reduxForm({
	form: 'TicketCreate',
})(TicketCreate);

const selector = formValueSelector('TicketCreate');
...
const mapDispatchToProps = dispatch => ({
	actionSelectEvent: (event, id) => dispatch(setAccessEvent2(event, id)),
