...
let PresaleCreate = ({
	...
	<div>
		...
		<Paper className={classes.createContainer}>
			<h6 className={classes.formTitle}>Nueva venta </h6>
			<form>
...
PresaleCreate = reduxForm({
	form: 'PresaleCreate',
})(PresaleCreate);

const selector = formValueSelector('PresaleCreate');
...
const mapDispatchToProps = dispatch => ({
	actionSelectEvent: (event, id) => dispatch(setAccessEvent4(event, id)),
